...
export async function ayudaCommand(ctx: Context): Promise<void> {
  const helpText = [
    ...
    '',
    '🍽 *Recetas*',
    '`/recetas` — Listar recetas',
    '`/receta <id>` — Ver detalle de receta',
    '`/receta crear <nombre> <desc> <tiempo> <porciones>` — Crear receta',
    '`/receta editar <id> <campo> <valor>` — Editar receta',
    '`/receta eliminar <id>` — Eliminar receta',
    '`/receta ingrediente agregar <rec_id> <ing_id> <cant> <unidad>` — Agregar ingrediente',
    '`/receta ingrediente quitar <rec_id> <ing_id>` — Quitar ingrediente',
    '`/receta ingrediente editar <rec_id> <ing_id> <cant> <unidad>` — Editar ingrediente',
    '`/receta producto listar <rec_id>` — Ver productos que usa la receta',
    '`/receta producto vincular <rec_id> <prod_id> <cant>` — Vincular producto a receta',
    '`/receta producto desvincular <rec_id> <prod_id>` — Desvincular producto de receta',
    '',
    '🧾 *Ventas*',
