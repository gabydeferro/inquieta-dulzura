...
describe('PaymentSelector Component', () => {
  ...
  it('renders all 7 payment methods', () => {
    render(<PaymentSelector total={10000} isSubmitting={false} onConfirm={onConfirm} />);
  ...
  it('displays the total amount', () => {
    render(<PaymentSelector total={14000} isSubmitting={false} onConfirm={onConfirm} />);
  ...
  it('disables confirm button when submitting', () => {
    render(<PaymentSelector total={14000} isSubmitting={true} onConfirm={onConfirm} />);
  ...
  it('shows empty cart message when total is 0', () => {
    render(<PaymentSelector total={0} isSubmitting={false} onConfirm={onConfirm} />);
