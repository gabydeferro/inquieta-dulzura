...
export const ProductoVentaSchema = z.object({
  ...
  nombre: z.string().min(2, 'El nombre del producto es requerido y debe tener al menos 2 caracteres.'),
...
export const VentaSchema = z.object({
  ...
  cliente: z.string().max(100, 'El nombre del cliente no puede exceder los 100 caracteres.').optional(),
